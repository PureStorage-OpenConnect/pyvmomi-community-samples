...
"""
 ...
 Simple pyVmomi program for attaching a LUN to all ESXi nodes of a cluster
...
def main():
    """
    Simple command-line program for attaching a LUN to all ESXi nodes
    of a cluster
    """
    ...
    try:
        ...
        for host in cluster.host:
            ...
            print ("Attaching SCSI lun " + args.lunuuid + " to cluster node " + host.name)
            storage_system.AttachScsiLun(args.lunuuid)
